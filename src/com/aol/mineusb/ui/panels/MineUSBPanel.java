package com.aol.mineusb.ui.panels;
...
import com.aol.mineusb.exceptions.LauncherNotFoundException;
...
public class MineUSBPanel extends JPanel {
	...
	public MineUSBPanel() {
		...
		try {
			this.bgImage = ImageIO.read(
					MineUSB.class.getResource("/com/aol/mineusb/res/dirt.png"))
	...
	public static JLabel getLogo() {
		if (logo == null) {
			...
			logo.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(
					MineUSB.class
							.getResource("/com/aol/mineusb/res/mineusb.png"))));
	...
	public static JLabel getDescriptionLabel() {
		if (description == null) {
			...
			description.setText("Use Minecraft on your USB key!");
		}
		return description;
	}
	...
	public static JLabel getAuthorsLabel() {
		if (authors == null) {
			...
			authors.setText("<html>Author: <font color=\"#00CC00\">67clement</font> "
					+ "<br />"
					+ " Contributors: <font color=\"#00CC00\">xolider</font>,"
					+ " <font color=\"#00CC00\">mentor6561</font></html>");
		}
		return authors;
	}
	...
	public static JButton getQuitButton() {
		if (quitButton == null) {
			...
			quitButton.setText("Quit MineUSB");
	...
	private static class ButtonsPanel extends JPanel {
		...
		public ButtonsPanel() {
			...
			try {
				this.bgImage = ImageIO.read(
						MineUSB.class
								.getResource("/com/aol/mineusb/res/stone.png"))
						.getScaledInstance(32, 32, 16);
			} catch (IOException e) {
				logger.error("Unexpected exception initializing MineUSB's panel");
			} catch (IllegalArgumentException ex) {
