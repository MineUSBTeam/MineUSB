...
public class LicenseFrame extends JFrame
{
    ...
    public LicenseFrame()
    {
        ...
        //panel.add(okButton);
        InputStream stream = MineUSB.class.getResourceAsStream("/fr/mineusb/res/LICENSE.txt");
        ...
        this.copyTextButton.addActionListener(e -> {
            try
            {
                StringSelection ss = new StringSelection(LicenseFrame.this.licenseTextArea.getText());
        ...
        this.selectAllButton.addActionListener(e -> {
            ...
            LicenseFrame.this.licenseTextArea.setSelectionEnd(LicenseFrame.this.licenseTextArea.getText().length());
        });
        ...
        this.setIconImage(Toolkit.getDefaultToolkit().getImage(MineUSB.class.getResource(MineUSBConstants.FAVICON_PATH)));
