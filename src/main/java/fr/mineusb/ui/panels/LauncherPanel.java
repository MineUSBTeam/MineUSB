...
public class LauncherPanel extends TexturedPanel
{
	...
	public static JLabel getLogo()
	{
		if (logo == null)
		{
			...
			try
			{
				logo.setIcon(new ImageIcon(ImageIO
						.read(MineUSB.class
								.getResource("/fr/mineusb/res/favicon.png"))
	...
	public static JLabel getTitle()
	{
		if (title == null)
		{
			title = new JLabel();
			title.setText("<html>"
					+ MineUSB.getLangUsed().getMineUSBLauncherTitleText() + "(v"
					+ MineUSB.LAUNCHER_VERSION + ")<html>");
